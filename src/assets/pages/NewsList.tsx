                            ...
                            <div className="l-board-box mt10">
                                ...
                                <div className="board-box mt10">
                                    <div className="box_cont open drop news all">
                                        <div className="guide_title arrow" onClick={() => openModal("news01")}>
                                            ...
                                            <div className="flex mo_tit">
                                                ...
                                                <span className="title">긴급출동 서비스가 추가된 미국 베이직 플러스 요금제 안내(06/30 ~ 이후)</span>
                                                ...
                                                <div className="cont_info">
                                                    <div className="board_view">
                                                        ...
                                                        <div className="board_view_top pb20">
                                                            ...
                                                            <h3 className="tit mb5">긴급출동 서비스가 추가된 미국 베이직 플러스 요금제 안내 (06/30 ~ 이후)</h3>
                                    ...
                                    <div className="box_cont open drop news all">
                                        <div className="guide_title arrow" onClick={() => openModal("news02")}>
                                            <p className="Fs_sm summary">2022-12-15</p>
                                            <div className="flex mo_tit">
                                                <span className="mr5 fwb">[공지]</span>
                                                <span className="title">픽업을 더 빠르게, 미국 Online Check in & Skip the Counter</span>
                                            </div>
                                        </div>
                                    ...
                                    <div className="box_cont open drop event all">
                                        <div className="guide_title arrow" onClick={() => openModal("event01")}>
                                            <p className="Fs_sm summary">2022-12-15</p>
                                            <div className="flex mo_tit">
                                                <span className="mr5 fwb primary">[이벤트]</span>
                                                <span className="title">차량 방역을 강화한 알라모렌터카와 함께 안전한 여행하세요!</span>
                                                <span className="wd_5 file_icon">
                                                    <img src="/img/icon/flie_icon.png" alt="" />
                                                    <img src="/img/icon/mo_file_icon.svg" className="mo_icon" alt="" />
                                                </span>
