                      ...
                      <div className="cont_info">
                        <div className="l-car-list">
                          <div className="car-list">
                            ...
                            <div className="mb10">
                                <b className="Title03 primary">중형</b>으로 무료 업그레이드
                            </div>
                          </div>
                      ...
                      <div className="cont_info">
                        <div className="l-car-list">
                          <div className="car-list">
                            ...
                            <div className="mb10">
                                <b className="Title03 primary">대형</b>으로 무료 업그레이드
                            </div>
                          </div>
                          <div className="car-list_price">
                            <span className="price-info Fs_sm">
...
export default RsvVihicleCoupon;
