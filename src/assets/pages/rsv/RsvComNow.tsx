      ...
      <main className="sub rsv-page" id="rsv-page">
        ...
        <section className="contents">
          <div className="inner">
                ...
                <div className="cont_info">
                  <ul>
                    <li className="line tac fwb wd_15">
                      픽업
                      <div className="Fs_xsm">Pick-up</div>
                    </li>
                    <li>
                      <ul>
                  ...
                  <ul>
                    <li className="line tac fwb wd_15">
                      반납
                      <div className="Fs_xsm">Drop-off</div>
                    </li>
                    <li>
                      <ul>
            ...
            <article className="l-box payment">
              ...
              <div className="box_cont">
                <div className="cont_title mb10">
                  (1) 지금 결제 금액
                  <span className="price-info Fs_sm">
                    USD <b className="Title03">110.40</b>/KRW{" "}
                    <b className="Title03">103,999</b>
                  </span>
                </div>
                <div className="cont_info Fs_xsm pt10">
                  2022년 09월 05일 하나은행(kebhana.com) 전신환매도율 기준
                  1377.80 적용됩니다.
                </div>
              </div>
              ...
              <div className="box_cont">
                <div className="cont_title mb10">
                  (2+3) 현지 결제 금액
                  <span className="price-info Fs_sm">
                    USD <b className="Title03">29.33 + TAX</b>
                  </span>
                </div>
                <div className="cont_info Fs_xsm pt10">
                  <ul>
            ...
            <article>
              <p className="error Fs_sm tac mb10">
                * 지금결제는 예약수정이 불가합니다
              </p>
              <div className="l-button flex jc-ct">
                <button
                  ...
                  onClick={() => openModal("rsv-cancle01")}
                >
                  예약취소(차감O)
                </button>
                <button
                  type="button"
                  className="button link button--cancle mr10"
                  onClick={() => openModal("rsv-cancle02")}
                >
                  예약취소(차감X)
                </button>
                <button
        ...
        {/* <!-- 예약취소01 차감 ㅇ --> */}
        <div id="rsv-cancle01" className="modal">
          <div className="modal-content2">
        ...
        {/* <!-- 예약취소02 차감 X --> */}
        <div id="rsv-cancle02" className="modal">
          <div className="modal-content2">
            <div className="modal-title Title03">예약취소</div>
            <span className="close fwb">&times;</span>
            <div className="cont_info">
              <p>예약 픽업일자 : 2021-01-11 12:00</p>
              <div className="ask-box mt10">
                <span className="primary fwb">152,983원 전액 환불</span>{" "}
                예정입니다.
                <br />
                예약을 취소하시겠습니까?
              </div>
