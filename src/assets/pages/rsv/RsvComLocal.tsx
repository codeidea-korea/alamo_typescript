      ...
      <main className="sub rsv-page" id="rsv-page">
        ...
        <section className="contents">
          <div className="inner">
            ...
            {/* <!-- sub title --> */}
            <article className="sub_title Title01 tac">예약완료</article>
                ...
                <div className="cont_info bt-0">
                  ...
                  <table className="table01 table-mo">
                    <tbody>
                      <tr>
                        <td colSpan={2}>
                          <span className="thead">이름</span> 홍길동
                        </td>
                      </tr>
                      <tr>
                        <td className="line">
                          <span className="thead">영문 성</span>HONG
                        </td>
                        <td>
                          <span className="thead">영문 이름</span>GILDONG
                        </td>
                      </tr>
                      <tr>
                        <td colSpan={2}>
                          <span className="thead">휴대폰 번호</span>+82 010
                          12345678
                        </td>
                      </tr>
                      <tr>
                        <td colSpan={2}>
                          <span className="thead">이메일 주소</span>
                          abcd@mail.com
                        </td>
                      </tr>
                      <tr>
                        <td colSpan={2}>
                          <span className="thead">도착 항공편</span>KE 107
                        </td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <article className="l-box rates-options">
              ...
              <div className="box_cont open drop">
                ...
                <div className="cont_info view pa20 toggle_cont">
              ...
              <div className="box_cont open drop mt10">
                <div
                  className="cont_title arrow toggle_btn toggle_tit2"
                  onClick={toggleHandle2}
                >
                  2. 추가옵션
                  <span className="price-info Fs_sm">
                ...
                <div className="cont_info view pa20 toggle_cont2">
              ...
              <div className="box_cont open drop mt10">
                ...
                <div className="cont_info view pa20 toggle_cont3">
                  <table className="table01 mb10">
                    <tbody>
                      <tr>
                        <td>
            ...
            <article className="l-box payment">
              ...
              <div className="box_cont open drop mt10">
                ...
                <div className="cont_info view pa20 toggle_cont4">
            ...
            <article className="l-box guide-box">
              ...
              <div className="box_cont open drop">
                ...
                <div className="cont_info view pa20 toggle_cont5">
                  <ul className="guide-explan circle Fs_xsm">
                    <li>
                      온라인 체크인은 운전면허증 정보와 현지에서 필요한 옵션 및
                      도착 정보를 사전에 입력하여 카운터에서의 시간을 절약할 수
                      있는 시스템 입니다.
                    </li>
                    <li>
                      온라인 체크인을 완료 하시더라도 필수 서류인 예약확정서,
                      국내 면허증, 국제 면허증, 여권, 주운전자 명의
              ...
              <div className="box_cont open drop mt10">
                ...
                <div className="cont_info view pa20 toggle_cont6">
                  <ul className="guide-explan number Fs_xsm index">
                    <li>
                      1. 수화물 찾는 곳 외부에 위치한 퍼플 스탑(purple stop)으로
                      이동하시어, 상시 운행중인 알라모 셔틀버스에 탑승하여
                      지점까지 이동하여 주시기 바랍니다
                    </li>
                    <li>
                    ...
                    <li>
                      4. 알라모 엘에이 국제공항 지점은 공항으로 부터 3마일 정도
                      떨어진 곳에 위치하고 있으며, 센츄리 블루버드(Century
                      Boulevard)로부터는 북쪽, 멘체스터 블루버드(Manchester
                      Boulevard)로부터는 남쪽에 위치하고 있습니다.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="box_cont open drop mt10">
                ...
                <div className="cont_info view pa20 toggle_cont7">
                  <ul className="guide-explan circle Fs_xsm">
                    <li>
                      알라모렌터카 한국 총판(www.alamo.co.kr) 에서는 본사
                      예약시스템을 기반으로 한 실시간 예약 서비스를 통해 예약을
                      대행해 드리고 있습니다.
                    </li>
                    <li>
                      차량 예약 시 결제가 이루어지지 않으며 알라모렌터카 한국
                      총판(www.alamo.co.kr) 에서 확정 받은 요금은 현지 지점에서
                      차량 픽업 시 결제됩니다.
                    </li>
                  </ul>
                  ...
                  <ul className="guide-explan circle Fs_xsm">
                    ...
                    <li>
                      필요 서류 : 주 운전자 명의의 한국여권, 신용카드, 국내 운전
                      면허증, 국제 운전 면허증, 예약 확정서 (하와이 지역의 경우
                      국제 운전 면허증은 필수 옵션이 아니므로 국내 운전
                      면허증만으로 차량 대여가 가능합니다.)
                    </li>
                  </ul>
                  ...
                  <ul className="guide-explan number Fs_xsm">
                    ...
                    <li>
                      1. 렌탈 가능 연령 : 만 25세 이상부터 대여 가능 하며, 만
                      21세~24세 이하의 경우 추가 비용(Under age Charge) 지불 시
                      이용가능 합니다.
                      <br />
                    ...
                    <li>
                      2. 렌탈 계약서 작성 시 유의사항: 차량 픽업 시 지점에서
                      계약서를 작성하며 응급출동서비스(RAP),유아 카시트 등 추가
                      옵션을 구매할 수 있습니다.
                      <br />
                      렌탈 계약서에 서명을 한 이후에는 추가로 발생한 비용에 대해
                      환불이 불가하오니 서명 전 계약서 내용을 반드시 확인하시기
                      바랍니다.
                      <br />
                      <br />
                    </li>
                    <li>
                      3. 차량 인수 지점과 반납 지점이 다를 경우, 편도비용(Drop
                      Charge)이 발생되며, 예약 마지막 단계의 Drop charge
                      항목에서 확인 가능합니다. 최종 예상 요금(Estimated
                      Total)에 편도 비용이 합산되어 반영됩니다.
                      <br />
                      <br />
                    </li>
                    <li>
                      4. 30일 이상 렌터카 픽업 시하는 장기렌탈건은 알라모렌터카
                      정책에 의해 30일 단위로 결제가 나뉘어 진행됨에 따라 계약서
                      및 인보이스도 나뉘어 발급됩니다. <br />
                      예를 들어, 90일 이용건의 경우 30일 단위로 총 3번의 결제로
                      나누어 진행하시게 됩니다.
                      <br />
                      또한 대여 기간 동안 차량 점검등의 이유로 지점의 요청에
                      의해 방문이 필요하실 수 있으니 현지 지점의 안내에 따라
                      주시기 바랍니다.
                    </li>
                  </ul>
                  ...
                  <ul className="guide-explan number Fs_xsm">
                    ...
                    <li>
                      ...
                      신용카드로 차량 이용금액의 약1~1.5배에 해당하는 금액이
                      보증금으로 가승인 처리가 됩니다.
                      <br />
                      차량 반납 시, 보증금은 자동 해지되며 실제 이용한 차량
                      요금은 보증금을 가승인 했던 신용카드로 자동 결제됩니다.
                      <br />
                      보증금은 신용카드 대금 결제일 이전까지 정상 승인이 되어
                      있더라도 실 청구는 되지 않습니다
                      <br />
                      미국 이용가능 신용카드: American Express®, MasterCard®,
                      VISA®, Discover® Network, JCB
                      <br />
                      <br />
                    </li>
                    <li>
                      2. 체크카드 이용 규정: 일부 지점에 한해 체크/데빗 카드
                      사용이 가능합니다. (MasterCard®, VISA®) 체크/데빗 카드
                      이용을 원하시는 경우 사전에 알라모렌터카 (02-739-3110)를
                      통해 이용 가능 여부를 확인하시기 바랍니다.
                      <br />
                      <br />
                    </li>
                    <li>
                  ...
                  <ul className="guide-explan number Fs_xsm">
                    <div className="guide-title fwb Fs_xsm">
                      예약 변경 및 취소
                    </div>
                    <li>
                      1. 예약변경
                      <ul>
                        <li>
                          ...
                          알라모렌터카 한국 총판(www.alamo.co.kr) 에서 대여 시간
                          기준 24시간 전까지 변경이 가능합니다.
                        </li>
                        <li>
                          2) 차량 픽업 시: 현지 지점에서 계약서 작성 시 차량
                          등급, 렌탈 기간 등을 변경하실 수 있으며 이때 변경되는
                          사항에 대해서는 알라모렌터카 한국 총판
                          (www.alamo.co.kr) 요금이 아닌 현지 요금으로
                          책정됩니다.
                        </li>
                        <li>
                          3) 차량 픽업 후: 렌트기간 및 반납 지점 변경을 원하시는
                          경우 픽업지점으로 연락하시어 변경 가능 여부를 확인해야
                          합니다. 추가 금액은 현지 요금 기준으로 책정됩니다.
                        </li>
                      </ul>
                      <br />
                      <br />
                    ...
                    <li>
                      ...
                      단위로 책정되며, 예정된 반납 시간보다 29분 이상 지연 시
                      하루 요금 단위로 추가 금액이 발생합니다.
                      <br />
                    ...
                    <li>
                      3. 사전 반납 : 예약한 반납일보다 하루 이상 먼저 반납 할
                      경우 이용 금액은 실제 이용한 일수로 계산되나, 예정보다
                      일찍 반납하신 것에 대해 Early Return Fee 금액이 패널티로
                      부과되며 패널티 금액은 지점마다 상이합니다.
                      <br />
                      <br />
                    </li>
                    <li>
                      4. 영업시간 외 반납 : 지점 영업시간 종료 후에도 차량
                      반납이 가능한 지점에 한해 영업시간 외 반납이 가능합니다.
                      차량 계약서 작성 시 지점 직원과 영업시간 외 반납 가능
                      여부에 대해 재확인하시기 바랍니다.
                      <br />* 영업 시간외 차량 반납 시, 지정된 구역에 주차 후,
                      차량 열쇠와 렌탈 자켓(Rental Jacket)의 마지막장을 작성해
                      키 드랍 박스(Key Drop Box)에 넣으시면 됩니다.
                      <br />
                      차량 이용 요금은 차량픽업 시 사용 하셨던 신용카드로 자동
                      청구 되며 다음날 지점 직원이 차량 상태를 점검한 이후 렌탈
                      계약이 최종적으로 종료 됩니다.
                      <br />
                      지점 직원에 의해 반납 절차가 완료되기 전까지 차량이
                      손상되거나, 주유가 되지 않은 경우, 고객님의 신용카드로
                      추가 요금이 자동 청구됩니다.
                      <br />
                      <br />
                    </li>
                    <li>
                      5. 예약 취소 : 스케쥴 변경 및 기타 사유로 인해 렌터카
                      이용이 불가능 하실 경우, 픽업일 기준 최소 1일 전까지
                      취소해 주시기 바랍니다.
                      <br />
                      예약한 시간보다 늦게 방문하실 경우 예약이 자동 취소될 수
                      있습니다. 예약 시간보다 늦게 지점에 도착하시는 경우 현지
                      지점으로 미리 고지해주시길 바랍니다.
                      <br />
                      <br />
                    </li>
                  ...
                  <ul className="guide-explan number Fs_xsm">
                    ...
                    <li>
                      ...
                      수량으로 인해 사전에 신청이 완료된 경우에라도 현지 지점의
                      상황에 따라 대여가 불가능할 수 있습니다.
                    </li>
                    <li>
                      1. 온라인 예약 시 추가 가능한 옵션
                      <ul>
                        <li>
                          1) 네비게이션 (GPS, USD12.99+세금/Day) : 한국어 언어
                          설정 시 한국어로 음성 안내를 받을 수 있으며, 경로
                          설정은 영어로만 지원이 가능합니다.
                        </li>
                        <li>
                          2) 유아 카시트 : 알라모렌터카 한국
                          총판(www.alamo.co.kr) 를 통해 예약 시 1개당
                          USD6.99+세금/Day, 현지 대여 시 1개당USD10.99+세금/Day)
                          미국 대부분의 주에서는 법적으로 몸무게가 약 36.29kg
                          이하의 아동은 유아 보호 좌석을 이용하도록 규정하고
                          있습니다.
                        </li>
                      </ul>
                      <br />
                    ...
                    <li>
                      2. 현지에서 추가 가능한 옵션 :<br />
                      - 현지에서 추가하신 옵션은 추가 옵션 비용에 대한 세금이
                      별도로 부과되며, 정확한 세금은 현지 지점에서 계약서 작성
                      시 확인할 수 있습니다.
                      <br />- 렌탈 계약서에 서명을 한 이후에는 추가로 발생한
                      비용에 대해 환불이 불가하오니 서명 전 계약서 내용을 반드시
                      확인하시기 바랍니다.
                      <ul>
                        <li>
                          1) 보험사항:
                          <ul className="number2">
                            <li>
                              ...
                              알라모렌터카 한국총판 (www.alamo.co.kr)을 통해
                              예약하신 경우, 자차보험(CDW)은 기본적으로 포함이
                              되어있으나, 요금제에 따라 대인/대물이 포함되어있지
                              않은 요금제도 있습니다.
                              <br />
                              *요금제에 대인/대물보험이 포함되어 있지 않아
                              현지에서 구매하시는 경우, SLP(Supplemental
                              Liability Protection)의 구매가 가능하며, 해당
                              보험의 단일보상한도는 USD300,000이며, 무보험 차량
                              보험(UM/UIM)은 커버되지 않습니다. (단, 무보험
                              차량보험이 필수인 주의 경우 커버가 가능하며 단일
                              보상한도는 USD300,000 입니다.)
                            </li>
                            <li>
                              1-2) 긴급차량출동서비스(Roadside Plus
                              /USD4.99~USD5.99 + 세금/Day) : 알라모렌터카 한국
                              총판(www.alamo.co.kr) 을 통해 베이직 플러스
                              요금제를 예약하신 경우에 한해서만 긴급
                              출동서비스가 포함 되어 있으며, 베이직 플러스
                              요금제를 제외한 다른 요금제에는 긴급출동 서비스가
                              포함되어 있지 않으며, 현지 지점에서 구매가
                              가능합니다.
                            </li>
                            <li>
                              1-3) 자손 보험(PAI/PEC ; Personal Accident
                              Insurance, USD6.50+세금/Day) : 알라모렌터카 한국
                              총판 (www.alamo.co.kr) 에서 제공하는 요금제에
                              포함되어 있지 않으며, 현지 지점에서 구매가
                              가능합니다.
                        ...
                        <li>
                          ...
                          USD15+세금/Day) : <br />주 운전자와 함께 현지 지점으로
                          방문하여 등록 해주셔야 하며, 주 운전자와 동일한 필수
                          지참 서류를 제시해야 합니다.추가운전자로 등록한
                          운전자만 렌터카를 운전할 수 있으며, 추가운전자 등록 후
                          이름 변경 및 교체는 허용되지 않습니다.*추가 운전자가
                          배우자일 경우 영문가족증명서를 지참하시면 추가 운전자
                          등록 비용이 면제 됩니다.
                        </li>
                        <li>
                          3) 연료 (FSO ; Upfront Fuel Service ) : <br />
                          기본적으로 차량 픽업 시, 연료가 가득 채워진 상태로
                          제공되며, 반납시 연료를 가득 채워서 반납하여야
                          합니다.(연료비는 개인 부담 항목입니다.)
                          <br />
                          연료가 가득 채워지지 않은 상태로 받으신 경우, 차량
                          인수 시 지점 직원에게 이 부분을 고지하신 후 차량
                          반납시 문제되지 않도록 지점 직원의 확인을 받으시길
                          바랍니다.
                          <br />
                          현지 지점을 통해 FSO 항목을 구입하거나 예약한 요금제에
                          포함되어 있을 경우 반납 시 연료를 채우지 않고 반납할
                          수 있습니다.
                          <br />* 뉴욕 맨하탄 지역에서 픽업하시는 경우,
                          베이직플러스 요금제 연료 1탱크 옵션 포함사항이
                          적용되지 않습니다.
                          <br />
                          FSO 옵션을 현지 지점에서 별도 구매하시면, 처음 계약서
                          작성 시, 이용 차량 등급의 평균 연료 탱크를 기준으로
                          금액이 책정되며 반납시 실제 이용하신 차량의 연료탱크를
                          기준으로 요금이 다시 책정됩니다.
                          <br />
                        ...
                        <li>
                          4) 차량 등급 변경/업그레이드 비용 (CAR CLASS CHANGE) :{" "}
                          <br />
                  ...
                  <ul className="guide-explan number Fs_xsm">
                    ...
                    <li>
                      ...
                      받으셔야 하며, 즉시 차량을 인수받은 알라모 현지 지점으로
                      알려주셔야 합니다.
                      <br />
                      <br />
                    </li>
                    <li>
                      2. 알라모렌터카에서는 응급상황을 대비하여 24시간 긴급 전화
                      서비스를 제공하고 있습니다.
                      <br />
                      한국어 통역서비스 역시 24시간 제공되므로 Korean Speaker
                      혹은 Korean interpreter를 요청하시면 통역서비스를 받으실
                      수 있습니다.
                      <br />
                    ...
                    <li>
                      3. 렌탈 기간 중 교통 법규 위반 및 유료 도로 통행료 등을
                      납부하지 않은 경우:
                      <br />
                      - 대납이 가능한 경우: 카메라에 찍힌 톨비, 교통 법규 위반과
                      같은 경우, 차량 반납 후에 알라모렌터카를 통해 별도의
                      행정수수료 비용과 함께 대납이 이루어집니다. 이때 고객님의
                      렌탈 정보를 해당 범칙금 발부 업체로 이관하는 데에 따른
                      행정수수료비 USD10~25이 범칙금외에 별도로 부과됩니다.
                      <br />
                      - 대납이 불가능한 경우: 직접 발부 받은 범칙금 티켓의 경우
                      대납이 불가하며, 고객님께서 직접 납부를 해주셔야 합니다.
                      <br />* 범칙금/유료도로 납부는 범칙금/유료도로 발부 업체
                      및 알라모렌터카 본사 규정에 따르며, 납부 방식은 사전 고지
                      없이 변경될 수 있습니다.
                      <br />
                      <br />
                    </li>
                    <li>
                      ...
                      오시거나 분실 하실 경우 패널티가 청구되며, 패널티 비용은
                      각 장비 및 해당 지점의 규정에 따라 상이 합니다.
                      <br />
                      * 보험, 추가 옵션 등 비용이 발생 되는 모든 요금은 본사
                      정책에 따라 변동될 수 있습니다.
                      <br />
                      * 기타 문의사항은 예약하신 여행사나 알라모렌터카
                      (02-739-3110)로 연락 주시기 바랍니다.
                      <br />
                      * 이 외 자세한 내용은 하기 ‘알라모 서비스-이용 가이드북’
                      혹은 홈페이지 상단 ‘이용가이드’ 를 통해서 확인 가능합니다.
                      <br />
                      <br />
                    </li>
                  </ul>
            ...
            <article>
              <div className="l-button flex jc-ct">
                <button
                  type="button"
                  className="button link button--cancle mr10 mbtn_full"
                  onClick={() => openModal("rsv-cancle")}
                >
                  예약취소
                </button>
                <button
                  type="button"
                  className="button link button--primary mbtn_full"
                  onClick={() => navigation("/rsv_nodify")}
                >
                  예약수정
                </button>
              </div>
