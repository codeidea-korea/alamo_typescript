                ...
                <div className="guide_list">
                  <ul className="l-box US tab_inner active">
                    ...
                    <li className="box_cont open drop">
                      <div
                        className="Note1 cont_title arrow pa30 toggle_btn toggle active toggle_tit"
                        ...
                        <ul className="board-box">
                          <li>
                            <div
                              ...
                              onClick={() => openModal("Note1_guide01")}
                            >
                              요금제 포함사항
                            </div>
                              ...
                              <div className="modal-content2">
                                ...
                                <div className="cont_info">
                                  <div className="info-detail">
                                    ...
                                    유료입니다.
                                    <br />
                                    주차구역은 주로 도로에 흰색이나 파란색
                                    등으로 표시되어 있습니다.
                                    <br />
                                    주차가 금지된 구역은 주로 도로에 노란색이나
                                    빨간색으로 표시되어 있습니다.
                                    <br />
                                    <br />
                                    구역 내에 주차를 위해서는
                                    ...
                                    1)인도에 설치된 주차권 발행기에서
                                    <br />
                                    2)주차를 원하는 시간 만큼의 금액을
                                    선지불하고
                                    <br />
                                    3)티켓을 받아 계기판에 보이도록 놓아 두어야
                                    합니다.
                                    <br />
                                    주차권 발행기는 동전으로 지불하고 거스름돈이
                                    나오지 않으므로 동전을 미리 준비해야 합니다.
                                    또한 한 번에 최대 주차할 수 있는 시간이
                                    정해져 있는 경우가 많으니 확인이 필요합니다.
                                    <br />
                                    <br />* 시간에 따라 주차가 금지 또는 무료인
                                    곳이 있으니 구역의 표지판을 확인해야 하며,
                                    'reserve' 표시가 되어 있는 구역은 등록된
                                    차량만 주차가 가능하므로 주의해야 합니다.
                                  </div>
                                  <div className="info-detail mt30">
                                    <b>2. 실내/실외 주차장 주차</b>
                                    <br />
                                    <br />
                                    주차장에 들어갈 때 티켓을 받고, 출차 시
                                    주차장의 정산기에서 금액을 지불한 후 해당
                                    티켓을 출구의 티켓 머신에집어 넣습니다.
                                    <br />
                                    주차장의 정산기들은 지폐로도 지불이
                                    가능하며, 잔돈을 받을 수 있습니다.
                                    <br />
                                    ...
                                    [도둑 방지 간단 Tip]
                                    <br />
                                    - 차 안 눈에 보이는 곳에 소지품을 놓지
                                    않습니다.
                                    <br />
                                    - 잠깐이라도 차를 떠날 때는 반드시 차 문을
                                    잠그거나 동행자가 차 안에 남아 있도록
                                    합니다.
                                    <br />- 도난이 걱정되는 경우에는 주차비는
                                    조금 더 높은 편이지만 안전한 실내 주차장에
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide02")}
                            >
                              보험종류
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide03")}
                            >
                              차량 인수 시 필수 지참사항
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide04")}
                            >
                              렌터카 예약, 언제 하나요?
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide05")}
                            >
                              요금 책정 기준
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide06")}
                            >
                              국제면허증 발급 방법
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide07")}
                            >
                              만 25세 미만 운전자
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide08")}
                            >
                              편도 렌탈
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide09")}
                            >
                              미국 편도 렌탈
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide10")}
                            >
                              하와이 편도 렌탈
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide11")}
                            >
                              장기 렌탈
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide12")}
                            >
                              지점에 한국인 직원이 있나요?
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide13")}
                            >
                              결제 방법
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note1_guide14")}
                            >
                              렌탈 절차
                            </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note2 cont_title arrow pa30 toggle_btn toggle active toggle_tit2"
                      ...
                      <div className="cont_info view hidden toggle_cont2">
                        <ul className="board-box">
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note2_guide01")}
                            >
                              차량 선택
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note2_guide02")}
                            >
                              2/4 door란?
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note2_guide03")}
                            >
                              차량조회 불가능
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note2_guide04")}
                            >
                              온라인 예약 절차 안내
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note2_guide05")}
                            >
                              동영상-등급 별 대표 차량안내
                            </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note3 cont_title arrow pa30 toggle_btn toggle active toggle_tit3"
                      ...
                      <div className="cont_info view hidden toggle_cont3">
                        <ul className="board-box">
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note3_guide01")}
                            >
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note3_guide02")}
                            >
                              추가 옵션
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note3_guide03")}
                            >
                              추가 운전자 등록
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note3_guide04")}
                            >
                              응급상황 대처 방법
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note3_guide05")}
                            >
                              항공기 연착
                            </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note4 cont_title arrow pa30 toggle_btn toggle active toggle_tit4"
                      ...
                      <div className="cont_info view hidden toggle_cont4">
                        <ul className="board-box">
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note4_guide01")}
                            >
                              주차하기
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note4_guide02")}
                            >
                              주유하기
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note4_guide03")}
                            >
                              컨버터블 차량 작동법
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note4_guide04")}
                            >
                              운전 시 주의사항
                            </div>
                          ...
                          <li>
                            <div
                              className="guide_title arrow"
                              onClick={() => openModal("Note4_guide05")}
                            >
                  ...
                  <ul className="l-box CA tab_inner">
                    ...
                    <li className="box_cont open drop">
                      <div
                        className="Note1 cont_title arrow pa30 toggle_btn toggle active toggle_tit5"
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note2 cont_title arrow pa30 toggle_btn toggle active toggle_tit6"
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note3 cont_title arrow pa30 toggle_btn toggle active toggle_tit7"
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note4 cont_title arrow pa30 toggle_btn toggle active toggle_tit8"
                        onClick={toggleHandle8}
                      >
                        렌터카 이용 팁
                      </div>
                  ...
                  <ul className="l-box GU tab_inner">
                    ...
                    <li className="box_cont open drop">
                      <div
                        className="Note1 cont_title arrow pa30 toggle_btn toggle active toggle_tit9"
                        onClick={toggleHandle9}
                      >
                        괌 예약 전 참고사항
                      </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note2 cont_title arrow pa30 toggle_btn toggle active toggle_tit10"
                        onClick={toggleHandle10}
                      >
                        렌터카 예약
                      </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note3 cont_title arrow pa30 toggle_btn toggle active toggle_tit11"
                        onClick={toggleHandle11}
                      >
                        렌터카 이용하기
                      </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note4 cont_title arrow pa30 toggle_btn toggle active toggle_tit12"
                        onClick={toggleHandle12}
                      >
                        렌터카 이용 팁
                      </div>
                  ...
                  <ul className="l-box MP tab_inner">
                    ...
                    <li className="box_cont open drop">
                      <div
                        className="Note1 cont_title arrow pa30 toggle_btn toggle active toggle_tit13"
                        onClick={toggleHandle13}
                      >
                        사이판 예약 전 참고사항
                      </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note2 cont_title arrow pa30 toggle_btn toggle active toggle_tit14"
                        onClick={toggleHandle14}
                      >
                        렌터카 예약
                      </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note3 cont_title arrow pa30 toggle_btn toggle active toggle_tit15"
                        onClick={toggleHandle15}
                      >
                        렌터카 이용하기
                      </div>
                    ...
                    <li className="box_cont open drop mt10">
                      <div
                        className="Note4 cont_title arrow pa30 toggle_btn toggle active toggle_tit16"
                        onClick={toggleHandle16}
                      >
                        렌터카 이용 팁
                      </div>
