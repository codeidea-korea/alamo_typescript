                        ...
                        <article>
                            ...
                            <div className="board-box mt10">
                                <div className="box_cont open drop rsv all">
                                    <div className="cont_title pa20 arrow toggle_btn toggle active toggle_tit" onClick={toggleHandle}>
                                        <span className="primary mr5">Q .</span>예약 관련 문의
                                    </div>
                                    <div className="cont_info view pa20 hidden toggle_cont">
                                        <p className="primary mb10">
                                            현지에서 계약서 작성 시 고객님께서 추가/변경하는 부분이 없다면, 예약 확정서 상의 최종 예상 요금 이외에 별도의 비용이 발생하지 않습니다. 서명된 부분에 대해서는 추후 환불이 불가하오니금액 추가를 원치 않는 경우, 렌탈
                                            계약서 상 포함된 항목이 없는지 꼼꼼히 확인하신 후 서명해주시길바랍니다.{" "}
                                        </p>
                                    </div>
                                </div>

                                <div className="box_cont open drop vehicle all">
                                    <div className="cont_title pa20 arrow toggle_btn toggle active toggle_tit2" onClick={toggleHandle2}>
                                ...
                                <div className="box_cont open drop use all">
                                    <div className="cont_title pa20 arrow toggle_btn toggle active toggle_tit3" onClick={toggleHandle3}>
                                ...
                                <div className="box_cont open drop europe all">
                                    <div className="cont_title pa20 arrow toggle_btn toggle active toggle_tit4" onClick={toggleHandle4}>
                                ...
                                <div className="box_cont open drop etc all">
                                    <div className="cont_title pa20 arrow toggle_btn toggle active toggle_tit5" onClick={toggleHandle5}>
                                ...
                                <div className="box_cont open drop terms all">
                                    <div className="cont_title pa20 arrow toggle_btn toggle active toggle_tit6" onClick={toggleHandle6}>
                                ...
                                <div className="box_cont open drop laws all">
                                    <div className="cont_title pa20 arrow toggle_btn toggle active toggle_tit7" onClick={toggleHandle7}>
                            ...
                            <div className="pagination">
                                <a href="/board/board_list.php?board_id=notice&amp;page=1" className="selected">
                                    1
                                </a>
                            </div>
                        </article>
