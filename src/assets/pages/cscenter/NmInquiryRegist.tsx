        ...
        <section className="contents">
          <div className="inner">
            ...
            <article className="sub_form">
                ...
                <fieldset>
                  <div className="form_input">
                    ...
                    <div className="select normal">
                      <div
                        className="disabled-selected flex ai-ct pl10"
                        onClick={inquiryHandle}
                      >
                        문의
                      </div>
                      <ul
                        className="list-member Fs_sm"
                        onClick={listMemberHandle}
                      >
                        <li>
                          <a
                            className="tab_item active"
                            href="#?"
                            data-category="inquiry01"
                          >
                            문의
                          </a>
                        </li>
                  ...
                  <div className="mt20">
                    <p className="fwb mfs12">
                      고객센터 월~금 09:00 ~ 17:00 (주말/공휴일 휴무)
                    </p>
                    <p className="Fs_sm summary mfs10">
                      운영시간 안에 주신 문의는 운영시간내 답변을 원칙으로 하며,
                      이메일로도 회신됩니다.
                    </p>
                  </div>
                </fieldset>
              ...
              <div className="l-button mt30 flex jc-ct btn_full">
                <button
                  type="button"
                ...
                <button
                  type="button"
                  className="button link button--primary mr10"
                  onClick={() => navigate("/inquiry_list")}
                >
                  문의하기
                </button>
              </div>
