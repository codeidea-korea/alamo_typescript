      ...
      <main className="sub" id="rsv_status">
        ...
        <section className="contents">
          <div className="inner">
            ...
            <article
              className="search-box form flex pa30 ico shadow"
            ...
            >
              ...
              <span className="mr5" style={{ flex: "1" }}>
                ...
                <input
                  type="text"
                  autoComplete="off"
                  className="search_input mr5 rem_l20"
                ...
                <div className="rsv_status_list">
                  <ul className="l-box">
                    <li className="box_cont open drop all tab1">
                      <div
                        className="Note1 cont_title arrow pa30 toggle_btn toggle flex ai-ct toggle_tit active"
                      ...
                      >
                        ...
                        <button
                          type="button"
                          className="button button--primary step Fs_sm ml10"
                        >
                          픽업예정
                          <svg
                  ...
                  0.375,0.375 45.63,38.087 0.375,75.8 "
                      ...
                      <div className="cont_info view hidden toggle_cont">
                        ...
                        <div className="l-button flex jc-ct">
                          <button
                            type="button"
                            className="button link button--cancle mr5"
                          >
                            예약취소
                          </button>
                          <button
                    ...
                    <li className="box_cont open drop mt10 all tab4">
                      <div
                        className="Note1 cont_title arrow pa30 toggle_btn toggle flex toggle_tit2 active"
                      ...
                      >
                        ...
                        <button
                          type="button"
                          className="button button--disabled step Fs_sm ml10"
                        >
                          NO SHOW
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  0.375,0.375 45.63,38.087 0.375,75.8 "
                    ...
                    <li className="box_cont open drop mt10 all tab2">
                      <div
                        className="Note1 cont_title arrow pa30 toggle_btn toggle flex toggle_tit3 active"
                  ...
                  0.375,0.375 45.63,38.087 0.375,75.8 "
                    ...
                    <li className="box_cont open drop mt10 all tab3">
                      <div
                        className="Note1 cont_title arrow pa30 toggle_btn toggle flex toggle_tit4 active"
            ...
            <div className="cont_info">
              <DateRangePicker
                ...
                onChange={(item) => {
                  ...
                  setStart(
                    `${item.selection.startDate?.getFullYear()}-${date(
                      item.selection.startDate?.getMonth()
                    )}-${item.selection.startDate?.getDate()}`
                  );
                  setEnd(
                    `${item.selection.endDate?.getFullYear()}-${date(
              ...
              <div className="l-button mt30">
                <button
                  type="button"
                  className="button full_button link button--primary calendar_close"
                >
                  확인
                </button>
              </div>
