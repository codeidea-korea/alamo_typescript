      ...
      <main className="sub" id="pickup_scheduled">
        ...
        <section className="contents">
          <div className="inner">
            ...
            <article className="l-box guide-box">
              ...
              <div className="box_cont open drop">
                ...
                <div className="cont_info view pa30 toggle_cont5">
                  ...
                  <button
                    type="button"
                    className="button button--primary mt20 py12 btn_full"
                  >
                    온라인 체크인 이용 가이드 다운로드
                  </button>
                </div>
            ...
            <article className="l-button flex jc-ct btn_full">
              <button
                type="button"
              ...
              <a href="/rsv_nodify" type="button" className="button link button--primary">
                예약수정
              </a>
            </article>
