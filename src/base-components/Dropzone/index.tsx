...
function Dropzone(props: DropzoneProps) {
  ...
  return (
    <div
      {...computedProps}
      ref={fileUploadRef}
      className="dropzone [&.dropzone]:border-2 [&.dropzone]:border-dashed [&.dropzone]:border-darkmode-200/60 [&.dropzone]:dark:border-white/5 [&.dropzone]:dark:bg-darkmode-600"
    >
