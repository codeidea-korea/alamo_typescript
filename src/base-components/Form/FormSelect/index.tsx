  ...
  return (
    <select
      ...
      className={twMerge([
        ...
        'w-full rounded-md border-slate-200 py-2 px-3 pr-8 text-sm shadow-sm transition duration-200 ease-in-out focus:border-primary focus:border-opacity-40 focus:ring-4 focus:ring-primary focus:ring-opacity-20 dark:border-transparent dark:bg-darkmode-800 dark:focus:ring-slate-700 dark:focus:ring-opacity-50',
