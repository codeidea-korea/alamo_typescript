  ...
  return (
    <Component
      className={twMerge([
        ...
        list.variant == 'tabs' &&
          tab.selected &&
          'border-slate-200 border-b-transparent bg-white font-medium dark:border-x-darkmode-400 dark:border-t-darkmode-400 dark:border-b-darkmode-600 dark:bg-transparent',
        list.variant == 'tabs' &&
          !tab.selected &&
