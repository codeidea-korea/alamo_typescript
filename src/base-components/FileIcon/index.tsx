  ...
  return (
    <div className={className} {...props}>
      <div
        ...
        className={clsx([
          'relative block bg-contain bg-center bg-no-repeat',
          "before:block before:w-full before:pt-[100%] before:content-['']",
        ])}
      >
        {variant == 'file' && (
          <div className="absolute top-0 bottom-0 left-0 right-0 m-auto flex items-center justify-center text-white">
            {type}
          </div>
        )}
        {variant == 'image' && (
          <div className="image-fit absolute top-0 left-0 h-full w-full">
            <img
