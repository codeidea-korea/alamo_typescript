  ...
  return (
    <div>
      {props.copyButton && (
        ...
        >
          <Lucide icon="File" className="mr-2 h-4 w-4" /> {copyText}
        </Button>
      )}
      <div
        ref={highlightRef}
        ...
        <pre className="relative grid">
          <code
            className={clsx([
              ...
              '[&.hljs]:dark:bg-darkmode-700 [&.hljs]:dark:text-slate-200 [&.hljs_.hljs-attr]:dark:text-sky-500 [&.hljs_.hljs-name]:dark:text-emerald-500 [&.hljs_.hljs-string]:dark:text-slate-200 [&.hljs_.hljs-tag]:dark:text-slate-200',
              "before:absolute before:top-0 before:right-0 before:block before:rounded-bl before:bg-slate-200 before:bg-opacity-70 before:px-4 before:py-2 before:font-roboto before:font-medium before:content-['HTML'] before:dark:bg-darkmode-400",
          ...
          <textarea
            ...
            value={copySource}
            onChange={() => {}}
            className="absolute -mt-1 -ml-1 h-0 w-0 p-0"
          ></textarea>
        </pre>
      </div>
    </div>
