...
export default function ReservationList() {
  ...
  const [showmemberReserve, setShowmemberReserve] = useState(false)
  ...
  const [RegistBtn, setRegistBtn] = useState(false) //삭제확인
  ...
  return (
    <>
      <div className="box mt-6">
        <div className="border-slate-200/6 space-between flex border-b p-3">
          <div className="flex items-center gap-2">
            <h2 className="mr-auto text-sm font-medium">지급일</h2>
            <div className="relative w-60">
              ...
              <Litepicker
                ...
                className="form-control form-control-sm pl-16"
              />
            </div>
          ...
          <div className="flex gap-2">
            <button className="btn btn-sm btn-primary">다운로드</button>
            <select
            ...
            <table className="table-hover table">
              ...
              <tbody className="text-center">
                <tr onClick={handleListClick}>
                  ...
                  <td>예약</td>
                  <td className="w-40">2022-11-11 11:11:11</td>
                  <td className="w-40">
                    판매가(USD) 2,003.00 / 판매가(KRW)220,000
                  </td>
                  <td className="w-40">
                    판매가(USD) 2,003.00 / 판매가(KRW)220,000
                  </td>
                  ...
                  <td>AUCEU</td>
                  <td>SFAR / FORD EDGE</td>
                  <td>USD 2,003.00 / KRW 220,000</td>
                  <td>USD 2,003.00 </td>
                </tr>
                        ...
                        <table className="table-bordered table">
                          ...
                          <tbody className="text-center">
                            <tr>
                              ...
                              <td>2022-11-11 11:11:11</td>
                              <td>LOS ANGELES INTL ARPT LAXT71</td>
                              <td>LOS ANGELES INTL ARPT LAXT71</td>
                              <td>SFAR / FORD EDGE OR SIMILAR</td>
                              <td>ACECUS / 300083</td>
                              <td>2,124.00</td>
                              <td>1,805.40</td>
                              <td>318.60</td>
                            ...
                            <thead>
                              <tr>
                                ...
                                <th className="flex items-center">
                                  <textarea
                                    className="form-control resize-none py-6 pl-16"
                                    placeholder=""
                                  ></textarea>
                                  <div className="pl-5">
                                    <button
                                      type="button"
                                      className="btn btn-primary-soft w-24"
                                      onClick={() =>
                                        setRegistBtn(true)
                                      }
                                    >
                      ...
                      <div className="flex flex-col gap-5 p-5">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="flex flex-col pl-10">
                            <div className="flex-end flex gap-2">
                              <button
                                className="btn btn-dark-soft w-24"
                                onClick={() => {
                                  setReceipt(true)
                                }}
                              >
      ...
      >
        <Dialog.Panel>
          <Dialog.Title>
            <h2 className="mr-auto text-base font-medium">회원 예약 정보</h2>
            <button
                ...
                <table className="table-bordered table">
                  <tbody>
                    <tr>
                      ...
                      <td className="w-per50">알라모</td>
                      <td className="w-40  whitespace-nowrap bg-slate-100">
                        아이디
                      </td>
                      <td className="w-per50">Akd</td>
                    </tr>
                    <tr>
                      <td className="w-40  whitespace-nowrap bg-slate-100">
                        한글 이름
                      </td>
                      <td className="w-per50">홍길동</td>
                      <td className="w-40  whitespace-nowrap bg-slate-100">
                        영문 이름
                      </td>
                      <td className="w-per50">Gildong hong</td>
                    </tr>
                    <tr>
                      <td className="w-40  whitespace-nowrap bg-slate-100">
                        이메일
                      </td>
                      <td className="w-per50">A@a.co.kr</td>
                      <td className="w-40  whitespace-nowrap bg-slate-100">
                        휴대폰번호
                      </td>
                      <td className="w-per50">010-111-111</td>
                    </tr>
                    <tr>
                      <td className="w-40  whitespace-nowrap bg-slate-100">
                        예약횟수(렌티드 횟수)
                    ...
                    <tr>
                      ...
                      <td className="w-per50">대한항공</td>
                      <td className="w-40  whitespace-nowrap bg-slate-100">
                        멤버십번호
                      </td>
                      <td className="w-per50">abdd111</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      >
        <Dialog.Panel>
          <Dialog.Title>
            <h2 className="mr-auto text-base font-medium">정산 히스토리</h2>
            <button
              className="btn btn-rounded-secondary hidden p-1 sm:flex"
              onClick={() => {
                setShowCalHistory(false)
      ...
      >
        <Dialog.Panel>
          <Dialog.Title>
            <h2 className="mr-auto text-base font-medium">예약취소</h2>
            <button
              className="btn btn-rounded-secondary hidden p-1 sm:flex"
              onClick={() => {
                setCancelModal(false)
          ...
          <Dialog.Description className="gap-4 gap-y-3">
            <div className="text-center text-lg font-bold">
              <span className="font-bold text-primary">[152,983원]</span>이 전액
              환불예정이에요.
              <br />
              예약을 취소하시겠습니까?
            </div>
            ...
            {/* <div className='text-center font-bold text-lg'>
              <span className='text-danger font-bold'>[152,983원]</span>차감 후 <span className='text-primary font-bold'>[152,983원]</span>이 전액 환불예정이에요.<br/>
              예약을 취소하시겠습니까?
           </div> */}
      ...
      >
        <Dialog.Panel>
          <Dialog.Title>
            <h2 className="mr-auto text-base font-medium">영수증</h2>
            <button
              className="btn btn-rounded-secondary hidden p-1 sm:flex"
              onClick={() => {
                setReceipt(false)
          ...
          <Dialog.Description className="gap-4 gap-y-3">
            <div className="text-center">pg사 영수증 출력</div>
          </Dialog.Description>
          <Dialog.Footer>
            <button
              type="button"
