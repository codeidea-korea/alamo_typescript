...
export default function CommonCodeChange({ open, setOpen }: Props) {
  ...
  return (
    <>
      ...
      >
        <Dialog.Panel>
          <Dialog.Title>
            <h2 className="mr-auto text-base font-medium">공통코드 상세/수정</h2>
            <button
          ...
          <Dialog.Description className="p-0">
            ...
            <div className="mt-3 pb-8 text-center">
              ...
              <button type="button" className="btn mr-2 w-24 bg-white"
                onClick={() => {
                  setOpen(false)
                }}
              >
