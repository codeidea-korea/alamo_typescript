...
export default function NoticeDetail({ isCreate }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="mt-8 flex items-center">
        <h2 className="mr-auto text-lg font-bold">공지사항 상세/수정</h2>
      </div>
      ...
      >
        <table className="table-bordered table">
          <tbody>
            ...
            <tr>
              <td className="w-40 bg-slate-100">최종수정자</td>
              <td>홍길동</td>
              <td className="w-40 bg-slate-100">최종수정일시</td>
