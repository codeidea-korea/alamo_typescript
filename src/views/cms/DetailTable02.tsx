...
import bannerImg2 from '@/assets/images/profile-12.jpg'
          ...
          <tbody>
            <tr>
              ...
              <td className="" rowSpan={4}>
                <div className="flex-center flex items-center">2</div>
              </td>
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <div className="form-check gap-2">
                    <input
                      ...
                      name="radio02"
                    />
                    <label className="form-radio-label" htmlFor="radio03">
                      N
                    </label>
                  </div>
                </div>
