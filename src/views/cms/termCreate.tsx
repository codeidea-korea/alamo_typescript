  ...
  return (
    <>
      <div className="intro-y mt-8 flex items-center">
        <h2 className="mr-auto text-lg font-bold">약관 등록</h2>
      </div>
      <div className="mt-3">
                        ...
                        <tr>
                          ...
                          <td className="">
                            <div className="flex items-center gap-2">
                              <select
                                className="form-select w-56 mr-2"
                                aria-label=".form-select-sm example"
                              >
                                <option>선택</option>
      ...
      <div className="mt-3">
        <div className="flex-center flex gap-2">
          ...
          <button className="btn btn-primary" onClick={() => setConfirm2(true)}>
            등록 (N으로 변경할 경우)
          </button>
        </div>
      </div>
      ...
      >
        <Dialog.Panel>
          ...
          <Dialog.Description className="gap-4 gap-y-3">
            <div className="text-center text-lg font-bold">
              공통약관 사용여부 변경 시 미노출됩니다. 정말 변경하시겠습니까?
            </div>
          </Dialog.Description>
          <Dialog.Footer>
            <div className="text-center">
