...
export default function NewsList() {
  const {
    ...
    url: '/contents/news-events',
    key: 'getNewsEventList',
  })
            ...
            <table className="table-hover check_table table">
              <thead className="table-dark text-center">
                <tr>
                  ...
                  <th>브랜드</th>
                  <th className="whitespace-nowrap">뉴스&이벤트 구분</th>
                  <th>제목</th>
                  <th>첨부</th>
                  <th>노출기간</th>
                  <th>노출여부</th>
              ...
              <tbody className="text-center">
                <tr>
                  ...
                  <td className="w-72">
                    2022-11-11 00:00:00 ~ 9999-11-11 00:00:00
                  </td>
                  <td className="w-24">Y</td>
                  <td className="w-24">3</td>
                  <td className="w-32">홍길동</td>
                  <td className="w-72">2022-11-11 11:11:11</td>
                </tr>
                <tr>
                  <td>
                    <input
