  ...
  return (
    <>
      <div className="intro-y mt-8 flex items-center">
        <h2 className="mr-auto text-lg font-bold">일반콘텐츠 상세/수정</h2>
      </div>
      <div className="box mt-3 overflow-x-auto p-3">
        <table className="table-bordered table">
          <tbody>
            ...
            <tr>
              <td className="whitespace-nowrap  bg-slate-100 ">전시 영역</td>
              <td>
...
export default ContentManageRevice
