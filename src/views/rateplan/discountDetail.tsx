  ...
  return (
    <>
      <div className="intro-y mt-8 flex items-center">
        <h2 className="mr-auto text-lg font-bold">요금할인 상세/수정</h2>
      </div>
      <div className="box mt-3 p-3">
        <table className="table-bordered table">
                                ...
                                <DropdownMenu className="w-350">
                                  <DropdownContent>
                                    ...
                                    <DropdownFooter>
                                      <button
                                        type="button"
                                        className="btn btn-primary ml-auto py-1 px-2"
                                      >
                                        확인
                                      </button>
                                    </DropdownFooter>
                        ...
                        <td>
                          ...
                          <div className="gap-2">
                            ...
                            {/* <Dropdown className="w-full">
                              <DropdownToggle className="btn btn-sm w-full">
                              ...
                              <DropdownMenu className="w-350">
                                <DropdownContent>
                                  <DropdownHeader>자동포함옵션</DropdownHeader>
                                  <DropdownDivider />
                                  <DropdownItem>
          ...
          <tr>
            <td className="whitespace-nowrap  bg-slate-100 ">차량</td>
            <td colSpan={5}>
              <select className="form-select w-56">
                <option value="">전체</option>
                <option value="">option1</option>
...
export default DiscountMngRevice
