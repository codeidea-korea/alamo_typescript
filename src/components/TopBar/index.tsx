  ...
  return (
    <>
      ...
      <div className="relative z-[51] flex h-[67px] items-center border-b border-slate-200">
        ...
        {/* BEGIN: Account Menu */}
        <Menu>
          <Menu.Button className="image-fit zoom-in intro-x block h-8 w-8 overflow-hidden rounded-full shadow-lg">
            {/* <img
              alt="Midone Tailwind HTML Admin Template"
          ...
          <Menu.Items className="mt-px w-56 bg-primary text-white">
            ...
            <Menu.Item className="hover:bg-white/5">
              <Lucide icon="Edit" className="mr-2 h-4 w-4" /> Add Account
            </Menu.Item>
            <Menu.Item className="hover:bg-white/5">
