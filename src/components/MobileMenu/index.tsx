...
import { enter, leave, linkTo } from './mobile-menu'
    ...
    <>
      ...
      >
        ...
        <div
          ref={scrollableRef}
          className={clsx([
            'top-0 left-0 z-20 -ml-[100%] h-screen w-[270px] bg-primary transition-all duration-300 ease-in-out dark:bg-darkmode-800',
...
function Menu(props: {
  ...
  return (
    ...
    >
      <div>{/* <Lucide icon={props.menu.icon} /> */}</div>
      <div className="ml-3 flex w-full items-center">
        ...
        {props.menu.subMenu && (
          ...
          >
            <Lucide icon="ChevronDown" className="h-5 w-5" />
          </div>
        )}
      </div>
    </a>
...
function Divider<C extends React.ElementType>(
  ...
  return (
    <Component
      ...
      className={clsx([
        props.className,
        'relative h-px w-full bg-white/[0.08]',
      ])}
    ></Component>
  )
}
